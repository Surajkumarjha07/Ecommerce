          ...
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
              <a className="block relative h-48 rounded overflow-hidden">
                <img alt="ecommerce" className="object-contain object-center w-full h-full block" src='https://m.media-amazon.com/images/I/61xcqiJNSWL._AC_UL480_FMwebp_QL65_.jpg' />
              </a>
              <div className="mt-4">
