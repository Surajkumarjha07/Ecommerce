          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">Shooting Stars</h2>
            ...
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">The Catalyzer</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">Neptune</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">Melanchole</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">Bunker</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-red-200 p-6 rounded-lg bg-red-100">
                ...
                <h2 className="text-lg text-red-900 font-medium title-font mb-2">Ramona Falls</h2>
                <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
              </div>
            </div>
          </div>
